...
const DESIGN_GIGS = [
  {
    title: "Sports Brand Logo & Identity",
    client: "Champions Gear SKT",
    budget: "PKR 3,500",
    duration: "3 days",
    skills: ["Illustrator", "Branding", "Logo"],
    level: "Beginner",
    deliverable: "Vector Files + PNG",
  },
  {
    title: "Product Packaging Design",
    client: "Sialkot Surgical Co.",
    budget: "PKR 5,000",
    duration: "1 week",
    skills: ["Photoshop", "Packaging", "Print"],
    level: "Intermediate",
    deliverable: "Print-Ready PDF",
  },
  {
    title: "Social Media Kit (30 Posts)",
    client: "SKT Trade Fair 2025",
    budget: "PKR 6,000",
    duration: "5 days",
    skills: ["Canva Pro", "Figma", "Social Media"],
    level: "Beginner",
    deliverable: "JPG/PNG Pack",
  },
  {
    title: "UI/UX Design for Mobile App",
    client: "QuickDeliver Sialkot",
    budget: "PKR 9,000",
    duration: "2 weeks",
  ...
  {
    title: "Export Catalogue Design",
    client: "Shehzad Leather Works",
    budget: "PKR 4,500",
    duration: "4 days",
    skills: ["InDesign", "Photoshop"],
    level: "Intermediate",
    deliverable: "PDF Catalogue",
  },
];
    ...
    <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
      <View style={styles.header}>
        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
          <Text style={styles.headerTitle}>🎨 Design Gigs</Text>
          <Text style={styles.headerSub}>
            {DESIGN_GIGS.length} opportunities in Sialkot
          </Text>
        </View>
      </View>
      ...
      >
        <View style={styles.infoBanner}>
          <Text style={styles.infoText}>
            ✨ Sialkot exports to 150+ countries. Local manufacturers need
            world-class branding & design. Turn your creativity into cash!
          </Text>
        </View>

        {DESIGN_GIGS.map((gig, i) => (
          <View key={i} style={styles.card}>
            ...
            <View style={styles.deliverableRow}>
              ...
              <Text style={styles.deliverableVal}>{gig.deliverable}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  deliverableRow: { flexDirection: "row", alignItems: "center", marginTop: 8 },
  deliverableLabel: { color: "#a0bfb5", fontSize: 12 },
  deliverableVal: { color: "#fff", fontSize: 12, fontWeight: "600" },
